...
func init() {
	...
	Builtin.MustRegister("User-Password", 2, AttributeString)
	...
	Builtin.MustRegister("Called-Station-Id", 30, AttributeText)
	Builtin.MustRegister("Calling-Station-Id", 31, AttributeText)
	...
	Builtin.MustRegister("Framed-AppleTalk-Zone", 39, AttributeText)
